...
function ohf_testing_google_apis_removal() {
    ?>
        ...
        <link rel='dns-prefetch' href='//fonts.googleapis.com.akubu.de' data-hint="must be removed" />
        <link rel='stylesheet' href='//fonts.googleapis.com.akubu.de/css?family=Montserrat%3A400%7CSource+Sans+Pro%3A400%2C400i%2C700&#038;subset=latin%2Clatin-ext&#038;display=swap&#038;ver=5.8' type='text/css' media='all' />
    <?php
}
